...
describe("sanitizeLabel", () => {
  ...
  it("should limit labels to 100 characters", () => {
  ...
  it("should preserve valid labels", () => {
    expect(sanitizeLabel("My Scan Label")).toBe("My Scan Label");
    expect(sanitizeLabel("Test-123")).toBe("Test-123");
  });

  it("should trim and limit together", () => {
    const longLabelWithSpaces = "  " + "a".repeat(150) + "  ";
    const sanitized = sanitizeLabel(longLabelWithSpaces);
    expect(sanitized.length).toBe(100);
